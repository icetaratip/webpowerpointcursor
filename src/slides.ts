...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    lead: '4 ผู้ก่อตั้งจาก MIT ที่มองเห็นว่า IDE ควรออกแบบมาเพื่อ AI ตั้งแต่ต้น ไม่ใช่แค่ติดปลั๊กอินทีหลัง',
    heroImage: 'https://img1.pic.in.th/images/2441b543-c13e-41ce-8448-16f8388f562c.png',
    items: [
      {
        label: 'CEO',
        text: 'Michael Truell',
      ...
      },
      {
        ...
        image:
          'https://blogbox.indianeagle.com/wp-content/uploads/2026/06/Cursor-cofounder-Aman-Sanger-MIT-billionaire-1536x961.png',
      },
      {
        label: 'Co-founder',
        text: 'Sualeh Asif',
      ...
      },
      {
        ...
        image: 'https://entrepreneurloop.com/wp-content/uploads/2025/10/arvid.jpeg',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    kicker: 'ลักษณะธุรกิจ',
    title: 'ลักษณะธุรกิจ',
    lead: 'Cursor ดำเนินธุรกิจในรูปแบบ Software as a Service (SaaS) หรือซอฟต์แวร์ที่ให้บริการผ่านระบบออนไลน์\nผู้ใช้สมัครแพ็กเกจแล้วใช้งานได้ทันที โดยไม่ต้องดูแลระบบเอง Cursor จึงให้บริการ AI Code Editor สำหรับนักพัฒนา ทีม และองค์กรได้แบบต่อเนื่อง',
    items: [
  ...
  },
  {
    ...
    title: 'ใช้ฟรีก่อน แล้วค่อยจ่ายเมื่อใช้จริงจัง',
    lead: 'Cursor ให้ผู้ใช้เริ่มใช้ฟรีก่อน จากนั้นคนที่ต้องการใช้งาน AI มากขึ้นหรือใช้เป็นทีมจึงอัปเกรดเป็นแพ็กเกจเสียเงิน',
    body: [
  ...
  },
  {
    ...
    kind: 'split',
    icon: 'sparkles',
    kicker: 'แพ็กเกจ · ฟรีและโปร',
    title: 'แพ็กเกจฟรีและแพ็กเกจโปร',
    items: [
      {
        label: 'แพ็กเกจฟรี',
  ...
  },
  {
    ...
    kind: 'split',
    icon: 'building',
    kicker: 'แพ็กเกจ · ทีมและองค์กร',
    title: 'แพ็กเกจสำหรับทีมและองค์กร',
    lead: 'สำหรับองค์กร',
    items: [
      {
  ...
  },
  {
    ...
    title: 'เติบโตจากตัวผลิตภัณฑ์เอง',
    lead: 'Cursor โตเพราะผู้ใช้ลองแล้วเห็นประโยชน์จริง จากนั้นจึงสมัครแพ็กเกจ จ่ายเงิน และชวนทีมมาใช้ต่อ',
    layout: 'side',
    chart: {
      type: 'funnel',
      ...
      points: [
        ...
        { label: 'อัปเกรดเป็นแพ็กเกจทีม', value: 28 },
        { label: 'ขยายเป็นแพ็กเกจองค์กร', value: 16 },
      ],
    },
  ...
  },
  {
    ...
    lead: 'ดีลนี้จ่ายด้วยหุ้นทั้งหมด และคาดว่าจะปิดดีลในไตรมาส 3 ปี 2026\nแสดงว่า Cursor ไม่ใช่แค่เครื่องมือช่วยเขียนโค้ด แต่เป็นทรัพย์สินด้าน AI ที่สำคัญต่อกลยุทธ์ขององค์กร',
  ...
  },
  {
    ...
    lead: 'Cursor ได้รับเงินลงทุนจากกองทุนชั้นนำ เช่น OpenAI Startup Fund, Andreessen Horowitz (a16z) และ Thrive Capital\nเพื่อนำไปพัฒนาตัวโปรแกรม ขยายทีมงาน และทำให้ธุรกิจโปรแกรมเขียนโค้ดด้วย AI เติบโตเร็วขึ้น',
  },
  {
    id: 'success',
    kind: 'grid',
    ...
    title: '10 เหตุผลที่ธุรกิจนี้โตได้',
    items: [
      ...
      { label: '05', text: 'ให้ใช้ฟรีก่อน แล้วค่อยจ่ายเมื่ออยากใช้มากขึ้น', icon: 'check' },
      ...
      { label: '09', text: 'รายได้แบบค่าสมาชิก ทำให้มีรายได้ต่อเนื่อง', icon: 'gauge' },
  ...
  },
  {
    ...
    logos: [{ src: brands.cursor, alt: 'Cursor' }],
    body: [
      'รายได้: ค่าสมาชิก · แพ็กเกจทีม · แพ็กเกจองค์กร · ค่าการใช้งาน AI เพิ่มเติม',
      'จุดแข็ง: ใช้งานง่าย · เข้าใจทั้งโปรเจกต์ · รองรับองค์กร',
      'บทเรียน: สินค้าต้องดีจนผู้ใช้อยากบอกต่อ · ให้ใช้ฟรีก่อน · เข้าถูกจังหวะ · แก้ปัญหาจริง',
    ],
